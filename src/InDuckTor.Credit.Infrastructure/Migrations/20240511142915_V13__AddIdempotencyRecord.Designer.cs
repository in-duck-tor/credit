...
namespace InDuckTor.Credit.Infrastructure.Migrations
{
    ...
    [Migration("20240511142915_V13__AddIdempotencyRecord")]
    partial class V13__AddIdempotencyRecord
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InDuckTor.Shared.Idempotency.Http.IdempotencyRecord", b =>
                {
                    ...
                    b.ToTable("IdempotencyRecord", "credit");
                });
                    ...
                    b.OwnsOne("InDuckTor.Shared.Idempotency.Http.IdempotencyRecord+Response", "CachedResponse", b1 =>
                        {
                            ...
                            b1.ToTable("IdempotencyRecord", "credit");
