...
namespace InDuckTor.Credit.Infrastructure.Migrations
{
    ...
    [Migration("20240324145753_V6__RemoveLoanBilling")]
    partial class V6__RemoveLoanBilling
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InDuckTor.Credit.Domain.LoanManagement.Loan", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("LoanBody", "InDuckTor.Credit.Domain.LoanManagement.Loan.LoanBody#ExpenseItem", b1 =>
                        {
                            b1.Property<decimal>("Amount")
                                .HasColumnType("numeric");
                        });

                    b.ComplexProperty<Dictionary<string, object>>("LoanDebt", "InDuckTor.Credit.Domain.LoanManagement.Loan.LoanDebt#ExpenseItem", b1 =>
                        {
                            b1.Property<decimal>("Amount")
                                .HasColumnType("numeric");
                        });
