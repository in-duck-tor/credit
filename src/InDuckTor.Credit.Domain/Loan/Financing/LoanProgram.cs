...
// 5. Мы уже знаем, что Заявка на Кредит валидна, поэтому сущность Кредита просто получает все нужные данные
//  и, через LoanService, для неё рассчитывается всё необходимое (количество платежей, например), после чего сущность сохраняется в состоянии Approved 
